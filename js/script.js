...
// Pesan
const WISH_MESSAGES = [
  "2 years and 6 months with you… and I still fall for you every day 💗",
  "you’re not just my love, you’re my comfort",
  "being with you feels like home",
  "I don’t need anything else, as long as I have you",
  "still you, still us, always ✨",
  "I’ll stay, no matter what happens",
  "you’re the best part of my life",
  "forever doesn’t feel scary with you ❤️"
];
...
function startIntro() {
	...
	setTimeout(() => {
		...
		setTimeout(() => {
			...
			// CUSTOM1
			setTimeout(() => {
				showIntroText('Happy 2 years and 6 months\nAnniversary\nAraa my love\n💗', false);
...
const backgroundMusic = {
	...
	init() {
		this.audio = new Audio('./https://cdn.yupra.my.id/yp/f8w8d70f.mp3');
